...
public class SecurityConfiguration {
		...
		http
				...
				.authorizeHttpRequests(auth -> auth
						.requestMatchers(
								...
								"/request-approval", "/notify-member","/pending","/all-members","/notify-guard/**", "/forgot-password", "/reset-password")
						.permitAll()
						...
						.requestMatchers("/member/dashboard", "/member/details/**", "/addComplaint", "/my-complaints",
								...
								"/my-payments", "/add-booking", "/delete-complaint", "/add-booking","/approve", "/reject")
						.hasRole("MEMBER")
	...
	public CorsConfigurationSource corsConfigurationSource() {
		...
		configuration.addAllowedOriginPattern("*"); // Allow
		// frontend
		// origin
